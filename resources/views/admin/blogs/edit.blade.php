<x-app-layout>
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8 bg-white">
        <form method="POST" action="/admin/edit-blog/{{$blog->id}}" enctype="multipart/form-data">
            @csrf
                ...
                <div class="border-b border-gray-900/10 pb-12">
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="mt-2">
                                <input type="text" name="title" id="street-address" autocomplete="street-address" value="{{ old('title', $blog->title) }}" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                        ...
                        <div class="sm:col-span-3">
                          <img class="w-28 h-14" src="{{ asset('storage/'. $blog->image )}}" alt="">
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                            <input type="text" name="author" id="last-name" value="{{old('author', $blog->author)}}" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                        <div class="sm:col-span-3">
                            <div class="mt-2">
                                <label for="last-name" class="block  text-sm font-medium leading-6 text-gray-900"><input {{ $blog->status ? 'checked': ''}} class="p-2 mr-1 -mt-1" type="checkbox" name="status"> Status</label>
                            </div>
                        </div>
                    </div>
